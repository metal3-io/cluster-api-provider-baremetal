...
.PHONY: binaries
binaries: manager clusterbaremetaladm ## Builds and installs all binaries

.PHONY: manager
manager: ## Build manager binary.
	go build -o $(BIN_DIR)/manager .

.PHONY: clusterbaremetaladm
clusterbaremetaladm: ## Build clusterbaremetaladm binary.
	go build -o $(BIN_DIR)/clusterbaremetaladm ./cmd/clusterbaremetaladm
...
generate-examples: clean-examples clusterbaremetaladm ## Generate examples configurations to run a cluster.
...
release-binaries: ## Builds the binaries to publish with a release
	RELEASE_BINARY=./cmd/clusterbaremetaladm GOOS=linux GOARCH=amd64 $(MAKE) release-binary
	RELEASE_BINARY=./cmd/clusterbaremetaladm GOOS=darwin GOARCH=amd64 $(MAKE) release-binary
